...
import com.openshop.rsyny.view.activity.HomeActivity;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ProductViewHolder> {
    ...
    public NewsAdapter(List<Article> articleslist, Context context , HomeActivity activity) {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        holder.tvSource.setText(articleslist.get(position).getSource().getName());
